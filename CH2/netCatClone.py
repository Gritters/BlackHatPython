...
#I don't have this working yet. Having issues with the help output. Need to troubleshoot it more.

def execute(cmd):
    cmd = cmd.strip()
    if not cmd:
        return
    output=subprocess.check_output(shlex.split(cmd),stderr=subprocess.STDOOUT)
